<template>
    <div class="main-one">
        <div class="mainOneIng">
            <div class="movies">
                <div class="The-hit" @click="TheHit">{{name}}</div>
            </div>
            <div class="More" @click="goticket(id)"><span>更多</span><van-icon name="arrow" /></div>
        </div>
        <div class="hitendupcoming">
            <div class="ss">
                <div class="main" v-for="item in hitendData1" :key="item.id" @click="goshowdetail(item.performanceId)">
                    <div class="main-img">
...
export default {
    ...
    methods: {
        ...
        TheHit() {
            this.axios
                .get(`https://yanchu.maoyan.com/myshow/ajax/performances/${this.id}`, {
                    params: {
                        sellChannel: 8,
                        cityId: this.cityId,
                    },
                ...
                .then((res) => {
                    this.hitendData1 = res.data.data.map((res) => {
                        return {
                             shopId: res.shopId,
